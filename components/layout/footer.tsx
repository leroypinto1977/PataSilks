      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-rich-brown">Patta Silks</h3>
            ...
            <div className="flex space-x-4">
              <Facebook
                size={20}
                className="text-gray-200 hover:text-rich-brown cursor-pointer transition-colors"
              />
              <Instagram
                size={20}
                className="text-gray-200 hover:text-rich-brown cursor-pointer transition-colors"
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-rich-brown">
              Quick Links
            </h4>
            <nav className="flex flex-col space-y-2">
              <Link
                href="/products"
                className="text-gray-200 hover:text-rich-brown transition-colors text-sm"
              >
                All Sarees
              </Link>
              <Link
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <MapPin size={16} className="text-rich-brown flex-shrink-0" />
                <span className="text-gray-200 text-sm">
                  123 Silk Street, Mumbai, India
                </span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone size={16} className="text-rich-brown flex-shrink-0" />
                <span className="text-gray-200 text-sm">+91 98765 43210</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={16} className="text-rich-brown flex-shrink-0" />
                <span className="text-gray-200 text-sm">
                  info@pattasilks.com
                </span>
              </div>
